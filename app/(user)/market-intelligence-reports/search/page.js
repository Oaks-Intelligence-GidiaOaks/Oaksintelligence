...
const query = groq`
 {
  "posts": *[_type=="market-intelligence-report" && title match $searchQuery] {
    ...,
  author->,
  categories[]->
  ...
  ,
  "total": count(*[_type == "market-intelligence-report" && title match $searchQuery]) 
}
`;
            ...
            <div className="flex w-[280px] md:w-[480px] justify-between">
              ...
              {Math.ceil(posts.total / ITEMS_PER_PAGE) > currentPage ? (
                <Link
                  ...
                  href={`/market-intelligence-reports/search?page=${
                    currentPage + 1
                  }&query=${searchQuery}`}
                >
