...
const query = groq`
 {
  "posts": *[_type=="eco-tales" && title match $searchQuery] {
    ...,
  author->,
  categories[]->
  ...
  ,
  "total": count(*[_type == "eco-tales" && title match $searchQuery]) 
}
`;
    ...
    <main className="min-h-screen bg-white dark:bg-main overflow-hidden">
      ...
      <div className="w-full">
        <div className="flex mx-auto justify-end max-w-[1560px] py-5 px-[5%] sm:px-[10%] items-center">
          <SearchBar placeholder="Search Eco-Tales" type={"eco-tales"} />
        </div>
      </div>
